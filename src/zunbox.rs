...
fn main() {
    ...
    if args.len() != 2 {
        println!("Gzip decompress some data. If there are spaces, surround in double quotes. Usage: zunbox 789c0bc94855482f4a4d2c5128c82f4f2d52c84f5348294f2c2a4bcd53c8cd4ccf28510400cc640c08");
        return;
    } 
